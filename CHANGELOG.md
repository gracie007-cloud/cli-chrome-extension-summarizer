...
- Chrome Side Panel chat: send full transcript + summary context (skip summary for oversized transcripts), add jump-to-latest, and improve auto-scroll + loading affordances.
